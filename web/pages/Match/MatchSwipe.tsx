...
const DSwipeCard: Component<{ character: AppSchema.Character;match: Any  }> = (props) => {
  ...
  return (
    ...
    <SwipeCard zindex="5" class="bg-[var(--bg-800)] fixed w-96 h-96 right-[5%] left-[5%] md:right-[10%] md:left-[10%] sm:w-9/12 sm:h-3/4 sm:max-w-[550px] sm:max-h-[550px] lg:right-[calc(14%-18.5rem)]  m-auto shadow-lg max-w-[90%] max-h-[90%] border-white border-solid border-[10px] md:border-[20px] rounded-lg"
